...
export default class Sales extends Component {
  componentDidMount() {
    ...
    // valueAxis1.title.text = "[font-size: 12]Mortgage Interest Rates";
    ...
    series3.name = "[font-size: 12]30-year mortgage interest rate";
    series3.stroke = am4core.color("#3eb489");
    ...
    bullet3.circle.stroke = am4core.color("#3eb489");
