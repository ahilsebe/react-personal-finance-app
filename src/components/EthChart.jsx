...
export default class Sales extends Component {
  componentDidMount() {
    ...
    axios
      ...
      .get("https://min-api.cryptocompare.com/data/v2/histohour?fsym=ETH&tsym=USD&limit=24&api_key={e6a54e3b9523cbc86de7aaec8faeea1c198adfd5ce0505318ec00b9fdf86e142}")
      .then(res => {
    ...
    valueAxis1.title.text = "[font-size: 12]$ETH";
    ...
    series3.name = "[font-size: 12]$ETH Price";
